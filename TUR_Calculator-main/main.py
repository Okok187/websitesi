...
def end(size, lights, device):
    return render_template('end.html',result=result_calculate(int(size),int(lights),int(device)),fiyat=fiyat(result_calculate(int(size),int(lights), int(device))),Değişken="/form")
# Form
@app.route('/form')
def form():
